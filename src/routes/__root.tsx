...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Projekt 13 — Professional Edition" },
      { name: "description", content: "Professionellt analysverktyg för sportspel och marknadsanalys." },
      { property: "og:title", content: "Projekt 13 — Professional Edition" },
      { property: "og:description", content: "Professionellt analysverktyg för sportspel och marknadsanalys." },
